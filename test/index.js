...
const nodeInfo = 'http://127.0.0.1:8000';

console.log(nodeInfo);
uranus.utils.default.setEndpoint(nodeInfo); // 设置节点rpc信息
...
const priv = '0x9c22ff5f21f0b81b113e63f7db6da94fedef11b2119b4088b89664fb9a3cb658';
...
const address = '0xC08B5542D177ac6686946920409741463a15dDdB';
...
// var result = uranus.uranus.sendTransaction(tx, signature);

// console.log('result', result);
// uranus.uranus.getBalance(1, `0xC08B5542D177ac6686946920409741463a15dDdB`, `latest`).then(function(result) {
//     console.log('result', result);
// });
...
payload += uranus.utils.default.getContractPayload(
    'transfer',
    ['address', 'uint256'],
    ['0x3f5ce5fbfe3e9af3971dd833d26ba9b5c936f0be', '10']
);
...
// tx.payload = uranus.utils.default.hex2Bytes(payload);

// tx.payload = Buffer.from('sign tx test');
const priv1 = '0x9c22ff5f21f0b81b113e63f7db6da94fedef11b2119b4088b89664fb9a3cb658';
var sig1 = uranus.singer.signTransaction(tx, priv1);

console.log('0000000', sig1);
const signature1 = uranus.utils.default.hex2Bytes(sig1);
...
let encryptPromise = wallet.encrypt(password, options);
...
let renderValue = new BigNumber(n.toString());
